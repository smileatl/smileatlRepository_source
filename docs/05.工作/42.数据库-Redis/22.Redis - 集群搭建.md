...
![image-20211226220119357](/assets/20211226220120.png)
...
![image-20211226221446834](/assets/20211226221447.png)

解决：

可以通过 {} 来定义组的概念，从而使 key 中 {} 内相同内容的键值对放到一个 slot 中去

![image-20211226221357024](/assets/20211226221358.png)
...
![image-20211226222301269](/assets/20211226222302.png)
